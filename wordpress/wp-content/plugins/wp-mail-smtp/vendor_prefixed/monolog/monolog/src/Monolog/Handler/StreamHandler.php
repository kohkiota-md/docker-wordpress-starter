...
class StreamHandler extends \WPMailSMTP\Vendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($stream, $level = \WPMailSMTP\Vendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false, $fileOpenMode = 'a')
    {
    ...
    protected function write(array $record) : void
    {
        ...
        if ($this->errorMessage !== null) {
            ...
            throw new \UnexpectedValueException('Writing to the log file failed: ' . $error . \WPMailSMTP\Vendor\Monolog\Utils::getRecordMessageForException($record));
        }
        $this->retrying = \false;
        if ($this->useLocking) {
