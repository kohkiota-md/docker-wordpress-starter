...
class SignalHandler
{
     ...
     */
    public function registerSignalHandler(int $signo, $level = \WPMailSMTP\Vendor\Psr\Log\LogLevel::CRITICAL, bool $callPrevious = \true, bool $restartSyscalls = \true, ?bool $async = \true) : self
    {
    ...
    public function handleSignal(int $signo, $siginfo = null) : void
    {
        ...
        $level = $this->signalLevelMap[$signo] ?? \WPMailSMTP\Vendor\Psr\Log\LogLevel::CRITICAL;
