...
class IntrospectionProcessor implements \WPMailSMTP\Vendor\Monolog\Processor\ProcessorInterface
{
     ...
     */
    public function __construct($level = \WPMailSMTP\Vendor\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \WPMailSMTP\Vendor\Monolog\Logger::toMonologLevel($level);
        $this->skipClassesPartials = \array_merge(['WPMailSMTP\\Vendor\\Monolog\\'], $skipClassesPartials);
